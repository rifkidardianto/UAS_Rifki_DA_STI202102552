...
import 'package:project_uas_rifki/coming_soon.dart';
import 'package:project_uas_rifki/module/order/bloc/orderLoadingBloc/order_loading_bloc.dart';
import 'package:project_uas_rifki/module/order/blocCubit/order_page_cubit.dart';
import 'package:project_uas_rifki/module/order/widget/app_bar_order.dart';
import 'package:project_uas_rifki/module/order/widget/history.dart';
import 'package:project_uas_rifki/module/order/widget/empty.dart';
import 'package:project_uas_rifki/module/order/widget/shimmer.dart';
  ...
  switch (state) {
    ...
    case OrderTab.dalamProses:
      return const OrderEmpty(
        ...
        title: "Pesan project_uas_rifki, yuk!",
